/*
 * File: app/view/admin_group/admin_group.js
 *
...
Ext.define('Portal.view.admin_group.admin_group', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.sys_admin_group',

    requires: [
        'Portal.view.admin_group.admin_groupViewModel',
        'Portal.view.admin_group.admin_groupViewController',
        'Ext.tab.Panel',
        'Ext.tab.Tab',
        'Ext.grid.Panel',
    ...
    controller: 'admin_groupadmin_group',
    viewModel: {
        type: 'admin_groupadmin_group'
    },
    autoShow: true,
    height: 354,
    width: 614,
                                    ...
                                    items: [
                                        {
                                            handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                                ...
                                                record,
                                                Ext.getStore('admin_group.group_main'),
                                                'data/admin_group/group_main-delete.php');
                                            },
                                            iconCls: 'icon-delete'
                                        }
                                    ]
