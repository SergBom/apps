Ext.define('Portal.util.Util', {
    ...
    statics : {
        ...
        appOrg:function(appClassName){
            var result='';
            Ext.Ajax.request({
				async:false,
                url:'data/PortalSecurity/appOrg.php',
                params:{appClassName:appClassName},
                success:function(r,o){result=Ext.decode(r.responseText);}
            });
            return result;
        },
