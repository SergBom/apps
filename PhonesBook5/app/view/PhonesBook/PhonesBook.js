            ...
            items: [
                ...
                },
                {
                    ...
                    tpl: [
                        ...
                        '<tbody><tr><td><b>{FIO}</b> <tpl if="say==0"><span class="user-nosay">*** Не отображается в справочнике ***</span></tpl></td>',
                        '<td colspan="1" rowspan="2"><img src="{userImageSrc}" height="64" width="64" style="float:right"></td>',
                        '</tr><tr><td>{dolzhnost_name}<br>{otdel_name}</td></tr>',
                        '<tr><td>{address_name}</td><td rowspan="1"><tpl if="off==2"> - <span class="user-off">Отсутствует с <span style="color:red;">{dateOff}</span> по <span style="color:red;">{dateOn}</span></span></tpl></td>',
                        '</tr><tr><td>Тел IP: {telIP}<br>',
                        'Тел 1: {tel1}<br>Тел 2: {tel2}<br>email: {email}</td><td>{refer}</td>',
                        '</tr></tbody></table>'
                    ],
                    bodyPadding: 10,
                    collapsible: true,
